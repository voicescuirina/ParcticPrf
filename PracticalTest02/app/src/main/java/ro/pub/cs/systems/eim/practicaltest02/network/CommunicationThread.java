...
public class CommunicationThread extends Thread {
    ...
    public void run() {
        ...
        try {
            ...
            HashMap<String, WeatherForecastInformationIrina> data = serverThread.getData();
            WeatherForecastInformationIrina weatherForecastInformation = null;
                ...
                if (false) {
                    ...
                    for (Element script : elements) {
                        ...
                        if (scriptData.contains(Constants.SEARCH_KEY)) {
                            ...
                            weatherForecastInformation = new WeatherForecastInformationIrina(
